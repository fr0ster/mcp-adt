...
def parse_args():
    parser = argparse.ArgumentParser(
        description="MCP ADT Server (Minimal Version) for SAP ABAP Development Tools",
...
mcp = FastMCP("ADT Server Minimal")
...
if __name__ == "__main__":
    ...
    # Run the MCP server
    print(f"[*] Starting Minimal MCP ADT Server with transport: {args.transport}")
